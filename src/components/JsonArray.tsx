...
import type { JsonArrayType } from "../types/JsonTypes";
...
interface Props extends JsonProps<JsonArrayType> {
  handleRemove?: () => void;
  dataType?: ObjectType;
}
...
class JsonArray extends Component {
  ...
  renderCollapsed() {
    ...
    const { handleRemove, readOnly, getStyle, dataType, minusMenuElement } =
      this.props;
  ...
  renderNotCollapsed() {
    ...
    const { minus, plus, delimiter, ul, addForm } = getStyle(
      name,
      data,
      keyPath,
      deep,
